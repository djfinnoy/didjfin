...
hljs.registerLanguage("r", function(e) {
    ...
    return {
        c: [e.HCM, {
            ...
            l: r,
            k: {
                keyword: "function if in break next repeat else for return switch while try tryCatch stop warning require library attach detach source setMethod setGeneric setGroupGeneric setClass ... bind_rows fromJSON toJSON paste paste0 select mutate summarize readLines writeLines str as_tibble length lengths map typeof fct_recode Sys.getenv glue get_json py_call py_to_r",
